...
public class RuleNodeActorMessageProcessor extends ComponentMsgProcessor<RuleNodeId> {
    ...
    RuleNodeActorMessageProcessor(TenantId tenantId, String ruleChainName,
                                  RuleNodeId ruleNodeId, ActorSystemContext systemContext,
                                  TbActorCtx actorCtx, RuleEngineSettings ruleEngineSettings) {
        ...
        this.defaultCtx = new DefaultTbContext(systemContext, ruleChainName, new RuleNodeCtx(tenantId, actorCtx, ruleNode), ruleEngineSettings);
    ...
    public void onRuleToSelfMsg(RuleNodeToSelfMsg msg) throws Exception {
        ...
        int maxRuleNodeExecutionsPerMessage = ruleEngineSettings.getMaxRuleNodeExecPerMsg();
    ...
    private void persistDebugInputIfAllowed(TbMsg msg, String fromNodeConnectionType) {
        if (ruleNode.shouldPersistDebugInput(msg.getTs(), ruleEngineSettings.getDebugModeDurationMinutes())) {
